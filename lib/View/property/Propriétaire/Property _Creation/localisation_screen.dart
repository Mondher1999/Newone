    ...
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          const Padding(
            padding:
                EdgeInsets.only(top: 20.0, right: 20, left: 20, bottom: 40),
            child: Text(
          ...
          Padding(
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: const Color.fromARGB(255, 255, 112, 137), width: 2),
  ...
  Widget _buildNavigationRow(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        TextButton(
          onPressed: (widget.property.lat != 1.3 &&
                  widget.property.lng != 1.2 &&
                  selectedRegion != regions.first)
          ...
          style: TextButton.styleFrom(
            ...
            backgroundColor: (selectedRegion != regions.first! &&
                    widget.property.lat != 1.3 &&
                    widget.property.lng != 1.2)
