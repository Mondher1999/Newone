...
class FirthScreen extends StatefulWidget {
  ...
  @override
  State<FirthScreen> createState() => _FirthScreenState();
}

class _FirthScreenState extends State<FirthScreen> {
  ...
  void initState() {
    super.initState();
    areaController.addListener(_updateButtonState);
  ...
  void dispose() {
    ...
    areaController.removeListener(_updateButtonState);
          ...
          children: <Widget>[
            ...
            Padding(
              padding: const EdgeInsets.only(
                  top: 20.0, right: 20, left: 20, bottom: 40),
              child: Text(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Positioned(
                      right: 15,
                      child: Icon(
                        Icons.square_foot_sharp, // Icon next to the text field
  ...
  Widget _buildNavigationRow(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        TextButton(
          onPressed: (areaController.text.isNotEmpty &&
                  selectedNumberOfRooms.isNotEmpty)
              ? _navigateToNextScreen
              : null, // Désactiver le bouton si les conditions ne sont pas remplies
          child: const Text('Suivant'),
          style: TextButton.styleFrom(
            foregroundColor: Colors.white,
            backgroundColor: (areaController.text.isNotEmpty &&
                    selectedNumberOfRooms.isNotEmpty)
