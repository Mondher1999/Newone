...
import 'package:madidou/View/property/Propri%C3%A9taire/Property%20_Creation/price_screen.dart';
...
import 'package:cross_file/src/types/io.dart' as io;
...
class _SeventhScreenState extends State<SeventhScreen> {
        ...
        children: <Widget>[
          ...
          Padding(
            padding: const EdgeInsets.only(
                top: 10.0, right: 20, left: 20, bottom: 40),
            child: Text(
  ...
  void _navigateTonextScreen() {
    // Si au moins une commodité est sélectionnée, procéder à la navigation
    Navigator.push(
      context,
      MaterialPageRoute(
